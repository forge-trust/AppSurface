...
| Source-bound warm PostgreSQL reference workload | 33 seconds | Passed 6 Work recovery scenarios plus forward migration rollback/retry; see [`warm/run.json`](https://github.com/forge-trust/AppSurface/blob/main/Durable/evidence/postgresql-slice7/warm/run.json). |
