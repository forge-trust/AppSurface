...
Do not use this package for a switcher, local-storage/cookie precedence, tenant lookup, or client-hint selection. The supported [browser-local](../Web/ForgeTrust.AppSurface.Web/README.md#browser-local-theme-preferences) and [request-aware](../Web/ForgeTrust.AppSurface.Web/README.md#host-owned-theme-selection) adapters live in AppSurface Web; cookie, account, tenant, client-hint, and content-varying approaches still require a separate privacy, CSP, caching, and first-paint design. Related follow-on policy work is tracked in [#706](https://github.com/forge-trust/AppSurface/issues/706), [#707](https://github.com/forge-trust/AppSurface/issues/707), and [#708](https://github.com/forge-trust/AppSurface/issues/708).
