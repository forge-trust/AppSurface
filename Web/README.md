...
- [**ForgeTrust.AppSurface.Web**](./ForgeTrust.AppSurface.Web/README.md) – The core web bootstrapping library, including [browser-local presentation preferences with one canonical document](./ForgeTrust.AppSurface.Web/README.md#browser-local-theme-preferences), [protected preview named deploy canary evaluation with bounded response evidence and fixed completion telemetry](./ForgeTrust.AppSurface.Web/README.md#named-canary-endpoints), conventional browser status pages, and opt-in production 500 pages.
