...
internal sealed class ConventionalExceptionPageRenderer
{
    ...
    private string ResolveViewPathUncached()
    {
        ...
        throw new InvalidOperationException(
            $"AppSurface conventional 500 pages are enabled, but neither '{ConventionalExceptionPageDefaults.AppViewPath}' nor '{ConventionalExceptionPageDefaults.FrameworkFallbackViewPath}' could be resolved.{Environment.NewLine}{locationsMessage}");
    }
