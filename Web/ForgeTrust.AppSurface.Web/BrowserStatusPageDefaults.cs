...
/// </summary>
/// <remarks>
/// AppSurface owns browser status pages for 401, 403, and 404 responses in this release. Production exception
...
public static class BrowserStatusPageDefaults
{
    ...
    /// </summary>
    /// <remarks>
    /// This prefix is reserved for AppSurface middleware and tooling. Applications should not register their own
    /// endpoints under this path because the framework maps supported integer status routes beneath it.
    /// </remarks>
    internal const string ReservedRouteBase = "/_appsurface/errors";
    ...
    /// AppSurface currently probes app overrides for 401, 403, and 404 by formatting this value.
    /// </remarks>
    ...
    /// <summary>
    /// Gets the endpoint route pattern used by AppSurface to map browser status page preview routes.
    /// </summary>
    /// <remarks>
    /// The <c>statusCode:int</c> route value keeps unsupported or malformed routes out of the renderer. The
    /// endpoint still validates the parsed integer against AppSurface's supported descriptors.
    /// </remarks>
    ...
    /// </remarks>
    internal const string FrameworkFallbackViewPath = "~/Views/_AppSurface/Errors/StatusPage.cshtml";

    /// <summary>
    /// Formats the conventional app override view path for the supplied HTTP status code.
    /// </summary>
    /// <param name="statusCode">
    /// The integer HTTP status code used for the view filename. AppSurface currently renders 401, 403, and 404.
    /// </param>
    ...
    /// </summary>
    /// <param name="statusCode">
    /// The integer HTTP status code used for the reserved route segment. AppSurface currently renders 401, 403,
    /// and 404.
    /// </param>
