...
{
    /// <summary>The fixed GET route pattern for evaluating a bounded snapshot of registered named canaries.</summary>
    public const string SnapshotRoutePattern = "/_appsurface/canaries";
