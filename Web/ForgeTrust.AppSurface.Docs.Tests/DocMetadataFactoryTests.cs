...
public sealed class DocMetadataFactoryTests
{
    ...
    [InlineData("docs/ForgeTrust.AppSurface.Web.Tests/README.md")]
    ...
    [InlineData("docs/AppSurface/overview.md", "AppSurface")]
    ...
    [Theory]
    [InlineData("ForgeTrust.AppSurface.Web.Tests", true)]
    [InlineData("ForgeTrust.RazorWire.Cli.Tests", true)]
    [InlineData("AppSurfaceBenchmarks.Web", true)]
    [InlineData("ForgeTrust.AppSurface.Docs", false)]
    ...
    [InlineData(@"docs\ForgeTrust.AppSurface.Web.Tests\README.md", "internals", "Internals", "contributor")]
