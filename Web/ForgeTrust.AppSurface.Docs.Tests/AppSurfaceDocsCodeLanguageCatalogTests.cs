...
public class AppSurfaceDocsCodeLanguageCatalogTests
{
    private readonly AppSurfaceDocsCodeLanguageCatalog _catalog = new();
    ...
    {
        Assert.Equal(expected, AppSurfaceDocsCodeLanguageCatalog.CreateSafeClassSlug(input));
    }
}
