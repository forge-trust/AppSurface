...
internal static class AppSurfaceDocsLocalizationFixture
{
    internal static AppSurfaceDocsLocalizationOptions CreateOptions()
    {
        return new AppSurfaceDocsLocalizationOptions
        {
            Enabled = true,
            DefaultLocale = "en",
            Locales =
