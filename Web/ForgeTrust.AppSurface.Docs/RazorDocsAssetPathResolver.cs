...
internal sealed class RazorDocsAssetPathResolver
{
    ...
    /// <c>~/_content/ForgeTrust.AppSurface.Docs/docs/appsurface-docs-icon.svg</c>. RazorDocs also maps this URL to an
    /// embedded-resource fallback when static web asset manifests are unavailable, which keeps packaged .NET tool
