...
/// </remarks>
public sealed class AppSurfaceDocsHarvestFailedException : InvalidOperationException
{
    /// <summary>
    /// Initializes a new instance of <see cref="AppSurfaceDocsHarvestFailedException"/> from a harvest-health snapshot.
    /// </summary>
    /// <param name="health">The failed harvest-health snapshot to summarize.</param>
    public AppSurfaceDocsHarvestFailedException(DocHarvestHealthSnapshot health)
        : this(DocHarvestFailureSummary.FromSnapshot(health))
    {
    }

    /// <summary>
    /// Initializes a new instance of <see cref="AppSurfaceDocsHarvestFailedException"/> from a redacted failure summary.
    /// </summary>
    /// <param name="summary">The redacted strict-harvest failure summary.</param>
    public AppSurfaceDocsHarvestFailedException(DocHarvestFailureSummary summary)
