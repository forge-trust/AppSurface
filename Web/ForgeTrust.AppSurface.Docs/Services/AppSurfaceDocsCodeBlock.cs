...
/// </summary>
/// <remarks>
/// <see cref="AppSurfaceDocsCodeBlock"/> stores only the first whitespace-delimited info-string token in
...
internal sealed record AppSurfaceDocsCodeBlock(string? Code, string? Language);
