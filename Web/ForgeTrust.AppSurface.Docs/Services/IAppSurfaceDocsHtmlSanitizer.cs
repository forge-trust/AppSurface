...
/// </summary>
/// <remarks>
/// <see cref="IAppSurfaceDocsHtmlSanitizer"/> exists to normalize rendered package documentation fragments before AppSurface Docs
...
/// </remarks>
public interface IAppSurfaceDocsHtmlSanitizer
{
    /// <summary>
    /// Sanitizes the provided HTML fragment.
    /// </summary>
    /// <remarks>
    /// <see cref="Sanitize"/> expects a non-null rendered AppSurface Docs HTML fragment, not a complete document or
    ...
    /// </remarks>
    /// <param name="html">The rendered AppSurface Docs HTML fragment to sanitize.</param>
