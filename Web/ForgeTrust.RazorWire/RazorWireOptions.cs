...
public class RazorWireTurboOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// The path must begin with one <c>/</c>, cannot contain a query string, fragment, percent encoding, dot segment,
    /// whitespace, or HTML-sensitive character, and is passed through ASP.NET Core static-asset versioning. Leave this
    /// value <see langword="null"/> in bundled and host-managed modes. Use
