...
public sealed class AppSurfaceDocsSearchPreloadRegression1Tests
{
    private readonly AppSurfaceDocsPlaywrightFixture _fixture;

    public AppSurfaceDocsSearchPreloadRegression1Tests(AppSurfaceDocsPlaywrightFixture fixture)
    {
        _fixture = fixture;
    }
