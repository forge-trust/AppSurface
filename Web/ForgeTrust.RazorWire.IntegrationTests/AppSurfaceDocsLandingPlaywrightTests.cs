...
public sealed class AppSurfaceDocsLandingPlaywrightTests
{
    private readonly AppSurfaceDocsPlaywrightFixture _fixture;

    public AppSurfaceDocsLandingPlaywrightTests(AppSurfaceDocsPlaywrightFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        // Regression: ISSUE-001 — the flagship /docs landing silently fell back to the neutral grid instead of promoting AppSurface.
        ...
        Assert.Equal("AppSurface", heading?.Trim());
    ...
    public async Task Landing_NavigatesToReleaseHub_CurrentReleaseAndUnreleasedProofArtifact()
    {
        ...
        Assert.Contains("v0.2.0-preview.2", await page.InnerTextAsync(".docs-content"), StringComparison.OrdinalIgnoreCase);
        ...
        await page.Locator(".docs-content a[href='/docs/releases/v0.2.0-preview.2']").First.ClickAsync();
        await WaitForPathAsync(page, "/docs/releases/v0.2.0-preview.2");
        await page.WaitForFunctionAsync(
            "() => document.querySelector('h1')?.textContent?.trim() === 'Release 0.2.0-preview.2'",
            null,
        ...
        Assert.Equal("Release 0.2.0-preview.2", (await page.TextContentAsync("h1"))?.Trim());
    ...
    public async Task DetailsPage_RendersContributorProvenanceStrip_AboveTrustBar()
    {
        ...
        Assert.Equal(
            "https://github.com/forge-trust/AppSurface/blob/main/releases/unreleased.md",
            await page.GetAttributeAsync(".docs-provenance-strip a.docs-provenance-link--primary", "href"));
        Assert.Equal(
            "https://github.com/forge-trust/AppSurface/edit/main/releases/unreleased.md",
