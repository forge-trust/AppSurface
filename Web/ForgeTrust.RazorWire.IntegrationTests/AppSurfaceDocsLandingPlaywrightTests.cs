...
public sealed class AppSurfaceDocsLandingPlaywrightTests
{
    ...
    public async Task Landing_NavigatesToReleaseHub_CurrentReleaseAndUnreleasedProofArtifact()
    {
        ...
        Assert.Contains("v0.1.0 RC 2", await page.InnerTextAsync(".docs-content"), StringComparison.OrdinalIgnoreCase);
        ...
        await WaitForPathAsync(page, "/docs/releases/v0.1.0-rc.2");
        await page.WaitForFunctionAsync(
            "() => document.querySelector('h1')?.textContent?.trim() === 'Release 0.1.0-rc.2'",
            null,
        ...
        Assert.Equal("Release 0.1.0-rc.2", (await page.TextContentAsync("h1"))?.Trim());
