...
{
    private const string PackageChooserReleaseNotePath = "/docs/releases/v0.2.0-preview.3";
    private const string PackageChooserReleaseNoteHeading = "Release 0.2.0-preview.3";
