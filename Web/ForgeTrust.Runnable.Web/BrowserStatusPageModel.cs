...
/// </param>
/// <remarks>
/// The framework renderer normalizes unsupported or unavailable route status values to 404 before creating the
/// default model, but custom producers should pass only status codes their view understands. <paramref name="OriginalPath"/>
/// and <paramref name="OriginalQueryString"/> are null for direct preview requests and can also be absent when
/// upstream middleware strips or replaces status-code re-execution metadata.
///
