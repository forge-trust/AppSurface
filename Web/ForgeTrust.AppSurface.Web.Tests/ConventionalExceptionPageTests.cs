...
public sealed class ConventionalExceptionPageTests
{
    ...
    public async Task EnabledMode_InProduction_RendersFrameworkFallback500_WithRequestId()
    {
        ...
        Assert.DoesNotContain("AppSurface default 500", html);
    ...
    public void ValidateConfiguredViews_ThrowsWithSearchedLocations_WhenNoViewsResolve()
    {
        var renderer = CreateRenderer(
            new StubCompositeViewEngine(
                ...
                frameworkResult: ViewEngineResult.NotFound(ConventionalExceptionPageDefaults.FrameworkFallbackViewPath, ["/Views/_AppSurface/Errors/500.cshtml"])));
        ...
        Assert.Contains("/Views/_AppSurface/Errors/500.cshtml", exception.Message);
    }
