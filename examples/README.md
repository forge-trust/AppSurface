...
- [Durable PostgreSQL example](durable-postgresql/README.md) – shows source-generated durable payload contracts, explicit PostgreSQL schema setup, enqueue/pump/status/control, full Cronos scheduling, runtime health and graceful drain, and continuous or externally activated workers.
