...
- [Web PWA worker proof](web-pwa-install/README.md) – shows AppSurface Web install metadata, combined offline and push-worker behavior, explicit browser registration, optional protected Web Push subscription and sender proof, development diagnostics, and CLI verification.
