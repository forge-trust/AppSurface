...
- `ForgeTrust.AppSurface.Auth.Testing` now gives integration tests deterministic personas, WebApplicationFactory helpers, diagnostics, and framework-neutral assertions while preserving real ASP.NET Core policy evaluation.
