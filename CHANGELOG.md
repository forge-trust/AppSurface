...
- [`ForgeTrust.AppSurface.Web.OpenApi`](./Web/ForgeTrust.AppSurface.Web.OpenApi/README.md) now requires `Microsoft.OpenApi` 2.7.5 or later and uses `Microsoft.AspNetCore.OpenApi` 10.0.9, preventing NuGet from selecting versions affected by [GHSA-v5pm-xwqc-g5wc](https://github.com/advisories/GHSA-v5pm-xwqc-g5wc) without changing OpenAPI or Scalar endpoint behavior.
