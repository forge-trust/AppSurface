...
- [`ForgeTrust.AppSurface.Web.OpenApi`](./Web/ForgeTrust.AppSurface.Web.OpenApi/README.md) now requires `Microsoft.OpenApi` 2.7.5 or later and uses `Microsoft.AspNetCore.OpenApi` 10.0.9, moving the default 2.x resolution above the range affected by [GHSA-v5pm-xwqc-g5wc](https://github.com/advisories/GHSA-v5pm-xwqc-g5wc) without changing OpenAPI or Scalar endpoint behavior. Downstream 3.x overrides must use 3.5.4 or later and be retested.
