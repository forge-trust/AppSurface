...
- AppSurface CLI now includes `appsurface coverage gate` for private Cobertura line/branch threshold enforcement with local JSON/Markdown reports, GitHub Actions step-summary output, and `ASCOV###` diagnostics.
