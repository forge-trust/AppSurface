...
- AppSurface Auth now includes `ForgeTrust.AppSurface.Auth.AspNetCore`, an ASP.NET Core bridge package for mapping host-owned request auth context and named policies into neutral AppSurface auth results without taking over schemes, middleware, challenges, or forbids.
