...
/// validated with DataAnnotations and scalar values can be validated with AppSurface scalar attributes or
...
public class ConfigStruct<T> : IConfig, IConfigInspectable
    where T : struct
{
    /// <summary>
    ...
    /// Override this method when a scalar rule is too specific for the built-in AppSurface scalar attributes.
    /// </summary>
