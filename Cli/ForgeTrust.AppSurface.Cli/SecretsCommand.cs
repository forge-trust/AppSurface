...
internal sealed partial class SecretsCommand : ICommand
{
    ...
    {
        await console.Output.WriteLineAsync("Use 'appsurface secrets init', 'set', 'get', 'list', 'migrate', 'delete', and 'doctor' to manage local development secrets, or 'appsurface secrets transfer plan|apply' for explicit remote transfer.");
    }
}
