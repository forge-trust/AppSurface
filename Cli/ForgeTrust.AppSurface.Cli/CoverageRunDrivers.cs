...
internal static class CoverageRunDriverStrategy
{
    ...
    public static void ValidateTestArguments(CoverageRunDriver driver, IReadOnlyList<string> arguments)
    {
        for (var index = 0; index < arguments.Count; index++)
        {
            ...
            if (argument == "--"
                ...
                || IsOwnedJoinedArgument(argument)
                || IsOwnedSplitArgument(argument))
            {
                throw CoverageRunDiagnostics.Create(
                    "ASCOV101",
    ...
    /// <summary>
    /// Normalizes exactly one validated collector attachment into the canonical project path.
    /// </summary>
    ...
    private static bool IsOwnedJoinedArgument(string value)
    {
        var prefixes = new[]
        {
