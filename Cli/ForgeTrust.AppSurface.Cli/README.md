...
Success prints the migration ID and `Complete`; a failure preserves its safe recovery
state for a retry of the identical command. A backend without this capability returns
