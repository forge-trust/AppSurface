...
namespace ForgeTrust.AppSurface.MarkdownSnippets.Tests;
...
public sealed class MarkdownSnippetGeneratorTests : IDisposable
{
    ...
    public async Task GenerateAsync_RewritesManagedBlockFromSourceMarker()
    {
        ...
        await WriteDocumentAsync(
            ...
            <!-- appsurface:snippet id="example" file="src/example.cs" marker="example" lang="csharp" -->
            ```csharp
            stale
            ```
            <!-- /appsurface:snippet -->
        ...
        Assert.Contains("public string Name => \"AppSurface\";", generated, StringComparison.Ordinal);
    ...
    public async Task GenerateAsync_PreservesIndentedManagedBlock()
    {
        ...
        await WriteDocumentAsync(
            ...
            1. Nested snippet:
                ...
                <!-- appsurface:snippet id="sample" file="src/sample.cs" marker="sample" lang="csharp" -->
                ```csharp
                old
                ```
                <!-- /appsurface:snippet -->
    ...
    public async Task VerifyAsync_IgnoresManagedClosingDirectiveInsideGeneratedCodeFence()
    {
        ...
        await WriteDocumentAsync(
            """
            <!-- appsurface:snippet id="sample" file="src/sample.html" marker="sample" lang="html" -->
            ```html
            old
            ```
            <!-- /appsurface:snippet -->
    ...
    public async Task GenerateAsync_RejectsInvalidBlockAttributes()
    {
        ...
        await WriteDocumentAsync(
            """
            <!-- appsurface:snippet id="sample" file="src/sample.cs" marker="sample" lang="c sharp" dedent="maybe" extra -->
            ```csharp
            old
            ```
            <!-- /appsurface:snippet -->
    ...
    public async Task GenerateAsync_RejectsUnsafeOrMissingSourcePaths(string sourcePath, string expectedMessage)
    {
        ...
        await WriteDocumentAsync(
            $"""
            <!-- appsurface:snippet id="sample" file="{sourcePath}" marker="sample" lang="csharp" -->
            ```csharp
            old
            ```
            <!-- /appsurface:snippet -->
    ...
    public async Task GenerateAsync_RejectsSourcePathThroughRepositorySymlink()
    {
        ...
        try
        {
            ...
            await WriteDocumentAsync(
                """
                <!-- appsurface:snippet id="sample" file="linked/sample.cs" marker="sample" lang="csharp" -->
                ```csharp
                old
                ```
                <!-- /appsurface:snippet -->
    ...
    public async Task GenerateAsync_ExtractsRazorCommentMarkers()
    {
        ...
        await WriteDocumentAsync(
            """
            <!-- appsurface:snippet id="scripts" file="Views/Shared/_Layout.cshtml" marker="scripts" lang="cshtml" -->
            ```cshtml
            old
            ```
            <!-- /appsurface:snippet -->
    ...
    public async Task GenerateAsync_DedentsByDefaultAndCanPreserveIndentation()
    {
        ...
        await WriteDocumentAsync(
            ...
            ```
            <!-- /appsurface:snippet -->
            <!-- appsurface:snippet id="sample-preserved" file="src/sample.cs" marker="sample" lang="csharp" dedent="false" -->
            ```csharp
            old
            ```
            <!-- /appsurface:snippet -->
    ...
    public async Task GenerateAsync_UsesLongerFenceWhenContentContainsBackticks()
    {
        ...
        await WriteDocumentAsync(
            """
            <!-- appsurface:snippet id="sample" file="src/sample.md" marker="sample" lang="md" -->
            ```md
            old
            ```
            <!-- /appsurface:snippet -->
