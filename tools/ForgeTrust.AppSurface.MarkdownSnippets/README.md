...
- `--document <path>`: Markdown file to generate or verify. Defaults to `Web/ForgeTrust.RazorWire/README.md`.
...
Do not use this for render-time includes. AppSurfaceDocs and other Markdown renderers should receive ordinary generated Markdown so package documentation stays portable across GitHub, NuGet, and static export surfaces.
