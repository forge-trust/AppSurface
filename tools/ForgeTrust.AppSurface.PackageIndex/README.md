...
The canonical bodies live in [`release-guidance.md.template`](https://github.com/forge-trust/AppSurface/blob/main/tools/ForgeTrust.AppSurface.PackageIndex/release-guidance.md.template). Each body expands the package chooser and
...
express the reader-facing posture, add one exact template pair in [`release-guidance.md.template`](https://github.com/forge-trust/AppSurface/blob/main/tools/ForgeTrust.AppSurface.PackageIndex/release-guidance.md.template), extend
