...
internal sealed class ReleaseSidecar
{
    ...
    /// <summary>
    /// Creates metadata for the frozen coordinated release pointer.
    /// </summary>
    /// <param name="version">The exact tagged release selected by the pointer.</param>
    /// <param name="date">The release date displayed in the trust metadata.</param>
    /// <returns>Canonical pointer-sidecar YAML.</returns>
    internal static string CurrentReleasePointerTemplate(SemVer version, DateOnly date)
    {
        return $"""
            title: Current coordinated release
            summary: Frozen pointer to AppSurface {version} for this published documentation tree.
            page_type: release-note
            nav_group: Releases
            order: 5
            breadcrumbs:
              ...
              - Current
            trust:
              status: Tree-local coordinated release pointer
              summary: This alias resolves to AppSurface {version}, the release current when this documentation tree was published.
              freshness: Frozen on {date:yyyy-MM-dd}; newer documentation trees can point at newer releases.
              change_scope: Repository-wide. It is a documentation alias, not a global latest-version lookup.
              archive: Historical documentation trees preserve their own current pointer and exact release link.
              sources:
                - Generated by ./eng/release prepare.
                - The matching tagged note is releases/v{version}.md.
            """;
    }
}
