...
`ForgeTrust.AppSurface.Intelligence` follows the AppSurface public-preview compatibility policy. The current package family release guidance is tracked in the [v0.1.0 release note](../../releases/v0.1.0.md), while the event contracts in this package remain `Experimental` until dogfood usage promotes them.
