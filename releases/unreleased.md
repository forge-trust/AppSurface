...
- AppSurface Docs static exports now carry those source-shaped recovery paths forward as validated redirect aliases, so CDN-hosted docs recover links pasted from repository Markdown paths without publishing duplicate page bodies.
