...
- RazorDocs source harvesting now has configurable global, Markdown, and C# path-policy scopes, including include/exclude globs and named default-exclusion controls for build output, hidden directories, test projects, and example C# source.
