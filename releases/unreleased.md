...
- AppSurface now plans two public CLI tools: `appsurface` for repository-level AppSurface workflows, starting with `appsurface docs` for AppSurface Docs preview, and `razorwire` for RazorWire-specific export workflows.
