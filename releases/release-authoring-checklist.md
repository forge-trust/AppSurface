...
- confirm the generated package path updates in [`packages/package-index.yml`](../packages/package-index.yml) point every `classification: public` plus `publish_decision: publish` package at the tagged note
