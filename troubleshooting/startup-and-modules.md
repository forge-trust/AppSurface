...
- For AppSurfaceDocs, check whether the app is mounted at `/docs` or a configured docs root.
...
For a normal ASP.NET Core app, start with `ForgeTrust.AppSurface.Web`. Add optional packages such as OpenAPI, Scalar, RazorWire, Tailwind, or AppSurfaceDocs only when the app needs them.
