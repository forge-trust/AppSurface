...
- `ForgeTrust.AppSurface.Cli`: Planned public `appsurface` .NET tool. The `docs` verb owns AppSurface Docs preview workflows that were previously sketched as a separate `appsurfacedocs` CLI. Release: excluded; not applicable; [notes](../releases/unreleased.md).
