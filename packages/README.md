...
- [v0.1.0-rc.3 release note](../releases/v0.1.0-rc.3.md) is the current package-facing story for this coordinated release.
...
- Add `ForgeTrust.AppSurface.Auth.AspNetCore` after `ForgeTrust.AppSurface.Auth` when ASP.NET Core host policies should flow into AppSurface auth results.
...
1. Add or update the package-local `THIRD-PARTY-NOTICES.md` file and pack it at package root with `<None Include="$(MSBuildProjectDirectory)\THIRD-PARTY-NOTICES.md" Pack="true" PackagePath="" />`.
