...
- [v0.1.0 Release Preview](../releases/v0.1-preview.md) is the consumer-facing story for the first coordinated release. It stays provisional until the tag is cut.
...
| `ForgeTrust.AppSurface.Auth` | Add this only when authoring AppSurface modules that need a stable cross-surface auth composition boundary. | `dotnet package add ForgeTrust.AppSurface.Auth` | AppSurfaceAuthModule, AppSurfaceAuthOptions, and Microsoft Options registration for the boundary-preview options root. | Authentication schemes or handlers, cookies, JWT/OIDC, ASP.NET Identity, authorization policies, middleware, endpoint filters, user/session contracts, challenges, forbids, or UI. | [Package README](../Auth/ForgeTrust.AppSurface.Auth/README.md) | public preview<br />commercial ready<br />[notes](../releases/v0.1-preview.md) |
